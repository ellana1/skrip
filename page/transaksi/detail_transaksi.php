...
if (isset($_POST['simpan'])) {
    ...
    VALUES ('" . $_POST['id_transaksi'] . "','$tipe', '" . $_POST['item_id'] . "', '" . $_POST['qty'] . "', '" . $total . "')";
    ...
    ";
    $query = mysqli_query($conn, $sql);
    echo "<script>alert('Data berhasil ditambahkan!'); window.location.href='?halaman=transaksi&aksi=detail&id=" . $_POST['id_transaksi'] . "'</script>";
}
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right">
                        ...
                        <a href="page/transaksi/print.php?id=<?php echo $row['id_transaksi']; ?>" class="btn btn-info" target="_blank"><i class="fa fa-print"></i></a>
                    </span>
                </div>
                <div class="card-body">
