        ...
        <div class="col-lg-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <?php
                    $id = @$_GET['id'];
                    $sql = mysqli_query($conn, "SELECT * FROM barang where barang_id = '$_GET[id]'") or die(mysqli_error());
                ...
                <form role="form" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Kategori" name="nama_kategori" required value="<?= $data['kategori_id'] ?>">
                        </div>
                        <div class="form-group">
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    $sql = "UPDATE barang set kategori_id='$kategori_id', kode_barang ='$kode_barang', nama_barang='$nama_barang', stok_id='$stok_id', harga='$harga' where barang_id='$barang_id'";
