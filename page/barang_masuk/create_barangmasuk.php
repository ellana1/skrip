            ...
            <div class="col-lg-12">
                <div class="box box-primary">
                        ...
                        <div class="box-body">
                             <div class="row">
                                <div class="col-md-12 col-xs-12 form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan nomor barang" name="kode_barang" required>
                    ...
                    if (isset($_POST['simpan'])) {
                        ...
                        $sql = "INSERT into barang_masuk values(NULL, '$kode_barang', '$tanggal', '$nama_barang', '$keterangan')";
