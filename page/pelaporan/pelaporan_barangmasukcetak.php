...
$sql="SELECT * from periode where id_periode='".$_GET['periode']."'";
// echo $sql;
...
<body>
  ...
  <div class="col-xs-2">
    <img src="../assets/img/logo-sd.png" style="width: 200px;">
  </div>
</div>
</div>
  ...
  <table id="dariom" class="table table-bordered table-striped ">
    ...
    <tbody>
      <?php
          ...
          INNER JOIN stok ON nama_barang.id = nama_barang.id
          WHERE nama_barang.id=$_GET[id]")or die(mysqli_error());
...
?>
       <tr>
        ...
        <td><img width="30px" src="../assets/image/<?= $row['foto'] ?>"></td> -->
        <td><?= $row['id'] ?></td>
      </tr>
    <?php endwhile; ?>
  </tbody>
