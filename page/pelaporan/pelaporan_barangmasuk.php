...
@session_start();
  // error_reporting(0);
include dirname(__DIR__,2) . '/config/connection.php';
$sql="SELECT * FROM 'barang_masuk'";
$print =mysqli_fetch_array(mysqli_query($conn,$sql));
?>
...
<body>
  <div class="col-lg-12" style="padding: 10px;border-bottom: 1px solid #333;">
   <div class="kop row" >
    <div class="col-xs-2">
     <img src="../assets/img/logo-bisma.png" style="width: 200px;">
   </div>
...
<div class="table-responsive" style="padding: 10px;">
  <h3 class="text-center">Pelaporan Barang Masuk <?php echo $print[0] ?></h3>
  ...
  <table id="dariom" class="table table-bordered table-striped ">
    ...
    <tbody>
      <?php
          ...
          $sql = query($sql="SELECT * FROM 'barang_masuk'");
          ?>
      <?php $data=mysqli_fetch_array(mysqli_query($conn,$sql)) ; ?>
      <?php var_dump($data)?>
